...
function AdminNavBar({children}) {
  const routes = [
    ...
    },
    {
      ...
      path: "/admin-dashboard/manage-timetable",
      svg: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    },
    {
      ...
      svg: (
        ...
        >
          <path
            id="ICON"
            d="M60 3.5H4a1 1 0 0 0 0 2h2.171A3 3 0 0 0 6 6.5v10.176a1 1 0 0 0 2 0V10h44a1 1 0 0 0 0-2H8V6.5a1 1 0 0 1 1-1h46a1 1 0 0 1 1 1V37a1 1 0 0 1-1 1H32V27.75c0-6.075-4.925-11-11-11h-2c-6.075 0-11 4.925-11 11v17.542A6.999 6.999 0 0 0 3 52v8a1 1 0 0 0 1 1h32a1 1 0 0 0 1-1v-8a7 7 0 0 0-5-6.708V40h23a3 3 0 0 0 3-3V6.5c0-.351-.06-.687-.171-1H60a1 1 0 0 0 0-2M30 47h-4.083A6.005 6.005 0 0 1 20 52a6.005 6.005 0 0 1-5.917-5H10a5 5 0 0 0-3.536 1.464A5 5 0 0 0 5 52v7h4v-4a1 1 0 0 1 2 0v4h18v-4a1 1 0 0 1 2 0v4h4v-7a5 5 0 0 0-1.464-3.536A5 5 0 0 0 30 47m-6.126 0h-7.748A4.006 4.006 0 0 0 20 50a4.006 4.006 0 0 0 3.874-3M30 45H10V27.75a9 9 0 0 1 9-9h2a9 9 0 0 1 9 9zm-2-17a1 1 0 0 0-1-1h-6.382l-1.724-3.447a.998.998 0 0 0-1.788 0L15.382 27H13a1 1 0 0 0-1 1v10a5 5 0 0 0 5 5h6a5 5 0 0 0 5-5zm-2 1v9a3 3 0 0 1-3 3h-6a3 3 0 0 1-3-3v-9h2a1 1 0 0 0 .894-.553L18 26.236l1.106 2.211A1 1 0 0 0 20 29zm14.5 6H52a1 1 0 0 0 0-2H40.5a1 1 0 0 0 0 2M37 30h15a1 1 0 0 0 0-2H37a1 1 0 0 0 0 2m0-5h15a1 1 0 0 0 0-2H37a1 1 0 0 0 0 2m0-5h15a1 1 0 0 0 0-2H37a1 1 0 0 0 0 2m-7-5h22a1 1 0 0 0 0-2H30a1 1 0 0 0 0 2"
          ></path>
        </svg>
      ),
    },
      ...
      <div className=" shadow-xl bg-[#1B1C21] h-screen  md:w-[25vw] lg:w-[20vw] overflow-y-hidden ">
        <div className=" h-[85%]">
          <div className="p-5 flex items-center align-bottom  ">
            ...
            <div className=" font-ubuntu pl-5 text-2xl">Admin</div>
          </div>
