  ...
  return (
    <div className="p-5">
      ...
      <div className="mt-12 flex gap-4">
        <div className="shadow-xl rounded-md w-1/2 min-h-[350px] border-r-2 border-dashed border-slate-500/20 px-4 py-2">
        ...
        <div className="shadow-xl rounded-md w-1/2 min-h-[350px] px-4 py-2">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-medium text-white">
