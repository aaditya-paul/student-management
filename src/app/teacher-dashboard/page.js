  ...
  return (
    <div className="p-5">
      ...
      <div className="flex flex-col gap-2 mt-10">
        ...
        <div className=" flex  gap-5">
          <div className="flex cursor-pointer hover:scale-105 transition-all ease-linear flex-col gap-5 bg-white/10 p-5 rounded-lg mt-5 w-[30%] h-[200px] ">
            <div className="text-xl font-semibold">Manage Assignments</div>
            <div className=" text-3xl text-amber-300 font-ubuntu">
              {/* {student.length ? (
                student.length
              ) : (
